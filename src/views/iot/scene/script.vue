		...
		<el-card v-show="showSearch" style="margin-bottom: 6px">
			<el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px" style="margin-bottom: -20px">
				<el-form-item label="脚本标识" prop="scriptId">
					<el-input v-model="queryParams.scriptId" placeholder="请输入脚本名" clearable @keyup.enter.native="handleQuery" />
				</el-form-item>
				<el-form-item label="脚本名" prop="scriptName">
					<el-input v-model="queryParams.scriptName" placeholder="请输入脚本名" clearable @keyup.enter.native="handleQuery" />
				</el-form-item>
				<el-form-item>
				...
				<el-form-item style="float: right">
					<el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd" v-hasPermi="['iot:script:add']">新增</el-button>
				</el-form-item>
			</el-form>
		</el-card>
		...
		<el-card style="padding-bottom: 100px">
			<el-table v-loading="loading" :data="scriptList" @selection-change="handleSelectionChange">
				...
				<el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200">
					<template slot-scope="scope">
						<el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)" v-hasPermi="['iot:script:edit']">修改</el-button>
						<el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)" v-hasPermi="['iot:script:remove']">删除</el-button>
					</template>
				</el-table-column>
			</el-table>
			...
			<el-dialog :title="title" :visible.sync="open" width="800px" append-to-body :close-on-click-modal="false" :close-on-press-escape="false">
					...
					<el-row :gutter="50">
						...
						<el-col :span="12">
							<el-form-item label="执行顺序" prop="scriptOrder">
								<el-input-number v-model="form.scriptOrder" placeholder="请输入脚本名" type="number" controls-position="right" style="width: 100%" />
							</el-form-item>
						</el-col>
						<el-col :span="12">
						...
						<el-col :span="12">
							<el-form-item label="所属产品" prop="productName">
								<el-input readonly v-model="form.productName" size="small" placeholder="请选择产品" style="margin-top: 3px">
									<el-button slot="append" @click="handleSelectProduct()" size="small">选择产品</el-button>
								</el-input>
							</el-form-item>
						</el-col>
				...
				<div slot="footer" class="dialog-footer">
                    <span style="float: left">
                        <el-link style="line-height: 40px; padding-left: 20px" icon="el-icon-question" :underline="false" type="primary" href="https://jakeai.cn/doc/pages/rule_engine/" target="_blank">
                            脚本使用Groovy引擎，查看教程>>>
                        </el-link>
                    </span>
					<el-button type="success" @click="handleValidate">验 证</el-button>
					<el-button type="primary" @click="submitForm" :disabled="!isValidate">保 存</el-button>
...
export default {
	...
	methods: {
		...
		reset() {
			...
			this.form = {
				id: null,
				applicationName: 'jakeai', // 后端配置和规则/脚本需要一致
				scriptId: null,
				productId: null,
				productName: '',
				scriptName: null,
