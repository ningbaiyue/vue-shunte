	...
	<div style="padding-left: 20px">
		<el-row :gutter="10" class="mb8">
			...
			<el-col :span="1.5">
				<el-button type="success" plain icon="el-icon-upload2" size="mini" @click="handleSelect"
						   v-if="productInfo.status == 1">导入通用物模型
				</el-button>
			</el-col>
			<el-col :span="1.5">
			...
			<el-col :span="1.5">
				<el-button type="info" plain icon="el-icon-view" size="mini" @click="handleOpenThingsModel">查看物模型
				</el-button>
			</el-col>
			<el-col :span="1.5">
		...
		<el-row>
			<el-form ref="form" :model="form" :rules="rules">
				<el-form-item label="请选择设备从机：" prop="datatype">
					<el-select value="integer" placeholder="请选择数据类型" @change="dataTypeChange">
						<el-option key="integer" label="从机1" value="integer"></el-option>
						<el-option key="decimal" label="从机2" value="decimal"></el-option>
					</el-select>
				</el-form-item>
			</el-form>
		</el-row>
		...
		<el-table v-loading="loading" :data="modelList" size="mini">
			...
			<el-table-column label="寄存器地址(10进制)" align="center" prop="identifier" width="230"/>
		...
		<el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
			<el-form ref="form" :model="form" :rules="rules" label-width="100px">
				...
				<el-form-item label="寄存器地址">
					<el-input v-model="form.identifier" placeholder="请输入寄存器地址"
							  style="width: 385px"/>
				</el-form-item>
				<el-form-item label="模型排序" prop="modelOrder">
					<el-input-number v-model="form.modelOrder" placeholder="请输入排序" type="number"
									 style="width: 386px"
				...
				<el-form-item label="取值范围" v-if="form.datatype == 'integer'">
					<el-row>
						<el-col :span="9">
							<el-input v-model="form.specs.min" placeholder="最小值" controls-position="right"
									  type="number"
				...
				<div v-if="form.datatype == 'integer' || form.datatype == 'decimal'">
					...
					<el-form-item label="步长">
						<el-input-number v-model="form.specs.step" placeholder="请输入步长，例如：1" type="number"
										 style="width: 386px"
										 controls-position="right"/>
					</el-form-item>
				...
				<el-form-item label="控制公式">
					<el-input v-model="form.identifier" placeholder="请输入控制公式"
							  style="width: 385px"/>
				</el-form-item>
					...
					<el-form-item label="枚举项" prop="">
						<el-row v-for="(item, index) in form.specs.enumList" :key="'enum' + index"
							...
							<el-col :span="2" :offset="1" v-if="index != 0"><a style="color: #f56c6c"
																			   @click="removeEnumItem(index)">删除</a>
							</el-col>
						</el-row>
						<div>
							+
					...
					<el-form-item label="对象参数" v-if="form.specs.arrayType == 'object'">
						<div style="background-color: #f8f8f8; border-radius: 5px">
							<el-row style="padding: 0 10px 5px" v-for="(item, index) in form.specs.params" :key="index">
								...
								<el-col :span="18">
									<el-input readonly v-model="item.name" size="mini" placeholder="请选择设备"
										...
										<el-button slot="append" @click="editParameter(item, index)" size="small">编辑
										</el-button>
									</el-input>
								</el-col>
