	...
	<div class="app-container">
		<el-card body-style="padding:10px" class="mb10">
			<el-row :gutter="30">
				<el-col :xs="24" :sm="24" :md="12" :lg="6" :xl="6">
					<div class="status-text flex align-left">
		...
		<el-card style="padding-bottom:100px;">
			<div class="flex-space-between mb10">
				<div class="flex">
					<div class="nav-title mr20"><span class="xian"></span>电量报表</div>
			...
			<el-table v-loading="loading" :data="tableList" show-summary sum-text="总计" stripe :header-cell-style="{'background': '#F7F7F7'}" border>
				...
				<el-table-column label="日充电量(kWh)" align="left" prop="country" />
				<el-table-column label="月充电量(kWh)" align="left" prop="address" />
				<el-table-column label="总充电量(kWh)" align="left" prop="city" />
				<el-table-column label="日放电量(kWh)" align="left" prop="axis" />
				<el-table-column label="月放电量(kWh)" align="left" prop="axis" />
				<el-table-column label="总放电量(kWh)" align="left" prop="axis" />
				<el-table-column label="日收益($)" align="left" prop="axis" />
				<el-table-column label="总收益($)" align="left" prop="axis" />
			</el-table>
