	...
	<div class="app-container">
		<el-card body-style="padding-bottom:4px;" class="mb10">
			<el-form :model="queryParams" ref="queryForm" size="small" :inline="true">
				...
				<el-form-item label="操作源" prop="name">
					<el-input
							v-model="queryParams.userName"
							placeholder="请输入操作源"
							clearable
				...
				<el-form-item label="控制命令" prop="city">
					<el-select v-model="queryParams.city" placeholder="请选择控制命令" clearable>
						<el-option
								v-for="item in cityList"
								:key="item.value"
								:label="item.label"
		...
		<el-card style="padding-bottom:100px;">
			<div class="flex-space-between mb10">
				<div class="nav-title"><span class="xian"></span>操作记录</div>
			...
			<el-table v-loading="loading" :data="tableList" stripe :header-cell-style="{'background': '#F7F7F7'}" border>
				...
				<el-table-column label="操作源" align="left" prop="axis" width="100" />
				<el-table-column label="配置修改记录" align="left" prop="axis" width="150" />
				...
				<el-table-column label="控制命令记录" align="left" prop="axis" width="100" />
				<el-table-column label="操作时间" align="left" prop="installTime" width="180" sortable>
					<template slot-scope="scope">
